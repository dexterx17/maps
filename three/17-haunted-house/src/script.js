...
const doorAmbientOcclusionTexture = textureLoader.load('/textures/door/ambientOclussion.jpg');
...
const bricksAmbientOcclussionTexture = textureLoader.load('/textures/bricks/ambientOclussion.jpg');
const bricksNormalTexture = textureLoader.load('/textures/bricks/normal.jpg');
const bricksRoughnessTexture = textureLoader.load('/textures/bricks/roughness.jpg');

const grassColorTexture = textureLoader.load('/textures/grass/color.jpg');
const grassAmbientOcclussionTexture = textureLoader.load('/textures/grass/ambientOclussion.jpg');
